...
<!-- Footer -->
<footer class="bg-primary text-light py-5 mt-5" role="contentinfo">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 mb-4">
                ...
                <address style="font-style: normal;">
                    ...
                    <p class="mb-1"><i data-lucide="mail" aria-hidden="true" class="me-2"></i> <a href="mailto:info@ascb.edu.ph" class="text-light text-decoration-none">asc-bislig.com</a></p>
