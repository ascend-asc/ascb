...
?>
<?php
$db->query("SELECT * FROM programs WHERE is_active = 1 ORDER BY CASE WHEN department='Basic Ed' THEN 1 WHEN department='Diploma' OR department='TVET' THEN 2 WHEN department='College' THEN 3 ELSE 4 END, name ASC");
...
<div class="container py-5">
    <div class="row g-4">
        ...
        <?php else: ?>
            ...
            <?php 
                $dept_display = $prog->department;
                if ($dept_display === 'TVET') {
                    $dept_display = 'Diploma';
                }
            ?>
            <div class="col-md-4">
                <div class="card h-100 shadow-sm border-0">
                    <div class="card-body d-flex flex-column">
                        <span class="badge bg-warning text-dark align-self-start mb-2"><?php echo htmlspecialchars($dept_display); ?></span>
